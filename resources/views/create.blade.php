...
<head>
    ...
    <!-- FAVICONS ICON -->
    <link rel="shortcut icon" type="image/png" href="{{ asset('note/images/favicon.png') }}">
    <link href="{{ asset('note/vendor/jquery-nice-select/css/nice-select.css') }}" rel="stylesheet">
    <link href="{{ asset('note/vendor/dropzone/dist/dropzone.css') }}" rel="stylesheet">
    <link href="{{ asset('note/css/style.css') }}" rel="stylesheet">
...
<body>
                                ...
                                <ul class="contacts">
                                    ...
                                    <li class="active dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('note/images/avatar/1.jpg') }}"
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('note/images/avatar/2.jpg') }}"
                                                    class="rounded-circle user_img" alt="">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('note/images/avatar/3.jpg') }}"
                                                    class="rounded-circle user_img" alt="">
                                                <span class="online_icon"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('note/images/avatar/4.jpg') }}"
                                                    class="rounded-circle user_img" alt="">
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                    ...
                                    <li class="dlab-chat-user">
                                        <div class="d-flex bd-highlight">
                                            <div class="img_cont">
                                                <img src="{{ asset('note/images/avatar/5.jpg') }}"
                                                    class="rounded-circle user_img" alt="">
                                                <span class="online_icon offline"></span>
                                            </div>
                                            <div class="user_info">
                                            ...
                                            <li>
                                                <div class="timeline-panel">
                                                    <div class="media me-2">
                                                        <img alt="image" width="50" src="{{ asset('note/images/avatar/1.jpg') }}">
                                                    </div>
                ...
                <ul class="metismenu" id="menu">
                    <li class="dropdown header-profile">
                        <a class="nav-link" href="javascript:void(0);" role="button" data-bs-toggle="dropdown">
                            <img src="{{ asset('note/images/profile/pic1.jpg') }}" width="20" alt="">
                            ...
                            <div class="card-body">
                                {{-- <div class="email-left-box px-0 mb-3">
                                    ...
                                    <div class="mail-list rounded overflow-hidden mt-4">
                                        ...
                                        <a href="email-inbox.html" class="list-group-item"><span
                                                class="icon-warning"><i class="fa fa-circle"></i></span>
                                            Work </a>
                                        <a href="email-inbox.html" class="list-group-item"><span
                                                class="icon-primary"><i class="fa fa-circle"></i></span>
                                            Private </a>
                                        <a href="email-inbox.html" class="list-group-item"><span
                                                class="icon-success"><i class="fa fa-circle"></i></span>
                                            Support </a>
                                        <a href="email-inbox.html" class="list-group-item"><span
                                                class="icon-dpink"><i class="fa fa-circle"></i></span>
                                            Social </a>
                                    </div>
                                </div> --}}
                                    ...
                                    <div class="mb-3">
                                        <form action="{{ route('store') }}" method="post">
                                            ...
                                            <textarea id="description" name="description" class=" form-control" rows="15"
                                                placeholder="Tell me about your feelings ..."></textarea>
    ...
    ***********************************-->
    <!-- Required vendors -->
    <script src="{{ asset('note/vendor/global/global.min.js') }}"></script>
    <script src="{{ asset('note/vendor/jquery-nice-select/js/jquery.nice-select.min.js') }}"></script>
    <script src="{{ asset('note/vendor/dropzone/dist/dropzone.js') }}"></script>
    <script src="{{ asset('note/js/custom.min.js') }}"></script>
    <script src="{{ asset('note/js/dlabnav-init.js') }}"></script>
    <script src="{{ asset('note/js/demo.js') }}"></script>
    <script src="{{ asset('note/js/styleSwitcher.js') }}"></script>
